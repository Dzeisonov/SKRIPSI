...
//        currentActivity = null
	...
	override fun onRequestPermissionsResult(
		...
		// We will keep whatever logic was inside the old function, if any.
		// The most important thing is to add a return value to satisfy the compiler.
		// Returning 'false' is the safest option, as it means "I did not handle this event".
		return false 
	}
